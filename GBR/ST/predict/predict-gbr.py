...
best_model = joblib.load('/home/ggx/wls/DAC-code/CR-X/HCOOH-C/GBR/ST/best_model.pkl')
best_scaler = joblib.load('/home/ggx/wls/DAC-code/CR-X/HCOOH-C/GBR/ST/best_scaler.pkl')
print("Model loaded successfully!")

# Load new data
new_data = pd.read_excel("/home/ggx/wls/DAC-code/CR-X/HCOOH-C/GBR/ST/predict/transformed_combined_features_2D.xlsx")  # Example of how to load new data
new_data 
...
output_file = "/home/ggx/wls/DAC-code/CR-X/HCOOH-C/GBR/ST/predict/predict_GBR-output-11ST-UL-HCOOH-C-2.xlsx"
