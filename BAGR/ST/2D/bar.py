...
param_grid = {
    # Bagging模型参数
    "n_estimators": list(range(50, 800, 50)),  # 基学习器数量
    ...
    "estimator__max_depth": list(range(2, 10, 1)),  # 树深度
