...
# 1. 读取数据
# ------------------------------------------------------------
data = pd.read_excel('/home/ggx/wls/work/DAC/CO/CrCr+训练/data/CrCr+UL-CO-sol.xlsx')
...
# 2. 载入模型 & Scaler
# ------------------------------------------------------------
best_model = joblib.load('/home/ggx/wls/work/DAC/CO/CrCr+训练/GBR/100-10best_model.pkl')
best_scaler = joblib.load('/home/ggx/wls/work/DAC/CO/CrCr+训练/GBR/100-10best_scaler.pkl')
