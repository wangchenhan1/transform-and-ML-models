...
param_grid = {
    "n_estimators": [350, 500, 700, 800, 1000, 1500, 2000],
    "learning_rate": [0.06, 0.01, 0.2, 0.5, 0.8],
    "estimator__max_depth": list(range(2, 31, 1)),
...
for state in random_states:
    ...
    ABR = AdaBoostRegressor(estimator=base_estimator)

    # 使用RandomizedSearchCV来寻找最优超参数
    grid_search = RandomizedSearchCV(ABR, param_grid, n_iter=100, cv=50, n_jobs=-1, scoring='r2')
