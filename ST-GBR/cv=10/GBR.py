...
# 从Excel文件中读取数据
data = pd.read_excel('/home/ggx/wls/DAC-code/co/UL/ST/data/ST-3-GBR-UL-CO-sol.xlsx')

X = data.iloc[:, 1:-1].to_numpy()
y = data.iloc[:, -1]

# 定义随机状态值范围
random_states = range(1, 5000)
results_all_states = {}
...
for state in random_states:
    ...
    grid_search = RandomizedSearchCV(GBR, param_grid, n_iter=100, cv=10, n_jobs=-1, scoring='r2')
